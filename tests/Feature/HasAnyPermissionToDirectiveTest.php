...
it('renders content when user has the required permission', function () {
    ...
    $compiled = Blade::render("@any_permission_to('permission,anotherPermission') Bienvenido @endany_permission_to");
...
it('does not render content when user lacks the required permission', function () {
    ...
    $compiled = Blade::render("@any_permission_to('noPermission,anotherPermission') Bienvenido @endany_permission_to");
